...
var functionsDomain = 'https://us-central1-dentsudemo-9ce77.cloudfunctions.net/twitter';
    	...
    	var docId = '';
		    ...
		    if (found) {
					db.collection("users").doc(docId).update({
					  state: 'win',
					  couponLink: 'https://rmarepo.richmediaads.com/o2o/dentsu/demo/coupon.html'
					})
					.then(() => {
						 resolve({
							data: {
